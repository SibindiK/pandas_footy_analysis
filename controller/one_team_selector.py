...
class OneTeamSelector(qtw.QMainWindow, Ui_oneTeamWindow):
    ...
    def one_team_data(self):
        ...
        if (_selected_team):
            ...
            _homes_ht_league_df = _analyser.build_ht_league_table('HomeTeam')
            _homes_ht_summary_df = _analyser.get_one_team_summary('HomeTeam', 
            ...
            _selected_team_away_model = PandasModel(
                    _analyser.get_one_team_aways_df(_selected_team))
            self.awayGamesTableView.setModel(_selected_team_away_model)
            #summarise away full time stats
            _away_ft_league_df = _analyser.build_ft_league_table('AwayTeam')
            _away_ft_summary_df = _analyser.get_one_team_summary('AwayTeam', 
            ...
            _away_ht_league_df = _analyser.build_ht_league_table('AwayTeam')
            _away_ht_summary_df = _analyser.get_one_team_summary('AwayTeam', 
